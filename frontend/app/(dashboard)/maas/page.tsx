    ...
    <div className="space-y-5">
      ...
      <div className="grid gap-5 xl:grid-cols-[1fr_380px]">
                ...
                {results.map((row) => {
                  ...
                  return (
                    <tr key={row["Ad Soyad"]}>
                      ...
                      <td className="max-w-[360px] text-[11px] text-slate-600 dark:text-slate-300">
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900">
          ...
          <p className="mt-1 text-xs text-slate-500">Araştırılmış dış veri manuel girilebilir. Girilmezse simülasyonda açıkça “İç Ücret Referansı” kullanılır.</p>
