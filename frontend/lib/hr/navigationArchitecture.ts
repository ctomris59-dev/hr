...
export type NavigationFamily = {
  ...
  label: string;
  section: "Çalışma Alanları" | "Sistem";
  description: string;
...
export const NAVIGATION_FAMILIES: NavigationFamily[] = [
  {
    id: "organization",
    label: "İnsan & Organizasyon",
    section: "Çalışma Alanları",
    description: "Kim nerede, kime bağlı, ekip deneyimi nasıl ve günlük insan operasyonlarında ne oluyor?",
    items: [
  ...
  {
    id: "performance",
    label: "Performans & Yetenek",
    section: "Çalışma Alanları",
    description: "Kim nasıl performans gösteriyor, hangi karar kanıta dayanıyor ve kim kritik yetenek segmentinde?",
    items: [
  ...
  {
    id: "talentCareer",
    label: "Gelişim & Kariyer",
    section: "Çalışma Alanları",
    description: "Kimi nasıl geliştirmeli, bir sonraki role ne kadar hazır ve kritik rollerde kim yedek olabilir?",
    items: [
  ...
  {
    id: "compensation",
    label: "Ücret & İşgücü Kararları",
    section: "Çalışma Alanları",
    description: "Kime ne kadar ve neden? Piyasa, iç adalet, bütçe ve yönetici önerilerini aynı karar alanında yönetin.",
    items: [
  ...
  },
  {
    ...
    label: "İşe Alım",
    section: "Çalışma Alanları",
    description: "Doğru adayı seçmek için başvuru, test, mülakat, iş örneği ve teklif kanıtlarını tek akışta yönetin.",
    items: [
  ...
  },
  {
    ...
    section: "Sistem",
    description: "Kurulum, kullanıcı, Türkiye uyumu, veri aktarımı, güven ve erişim politikalarını tek sistem alanında yönetin.",
    items: [
      ...
      { href: "/turkiye-uyum", label: "Türkiye Uyum", description: "KVKK-by-design ve SGK/Logo/Mikro/Netsis entegrasyon readiness görünümü." },
