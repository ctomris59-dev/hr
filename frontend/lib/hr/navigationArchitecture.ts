...
export const NAVIGATION_FAMILIES: NavigationFamily[] = [
  ...
  },
  {
    ...
    section: "İnsan & Organizasyon",
    description: "9-Box, yetkinlik grafiği, kariyer hazır bulunuşluğu ve halefiyeti aynı yetenek karar zincirinde görün.",
    items: [
      { href: "/yetenek-matrisi", label: "Yetenek & 9-Box", description: "Performans, potansiyel ve Evidence Score ile yetenek görünümü." },
      { href: "/yetkinlik-haritasi", label: "Yetkinlik Haritası", description: "Çalışan, rol ve yetkinlik bağlarını kanıta dayalı Skills Graph'ta görün." },
