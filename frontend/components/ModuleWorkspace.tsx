...
const MODULES: ModuleConfig[] = [
  ...
  },
  {
    ...
    description: "Çalışan, departman, pozisyon, yönetici ve kıdem bilgisini premium çalışan dizininde yönetin.",
    focus: "Çalışan ana verisini güncel tutun; eksik yönetici, pozisyon ve departman bağlantılarını görünür hale getirin.",
    steps: ["Çalışanlar", "Departman", "Pozisyon", "Yönetici Bağları"],
    icon: Building2,
    accent: "#2563eb",
    accent2: "#475569",
    soft: "#eff6ff",
