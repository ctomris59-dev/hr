...
const MODULES: ModuleConfig[] = [
  ...
  { path:"/degerlendirme",id:"degerlendirme",title:"Performans & Yetkinlik",focus:"Eksik veriyi ortalama saymadan KPI, yönetici gözlemi ve yetkinlik kanıtını dönem içinde tamamlayın.",steps:["Dönem","Hedef","Kanıt","Kaydet"],icon:RefreshCw,accent:"#4f46e5",accent2:"#7c3aed",soft:"#eef2ff" },
  ...
  { path:"/egitim",id:"egitim",title:"Eğitim",focus:"Eğitimi tek başına hedef değil, gelişim planındaki aksiyonlardan biri olarak yönetin.",steps:["Katalog","Atama","Transfer","Ölçüm"],icon:BookOpen,accent:"#0891b2",accent2:"#2563eb",soft:"#ecfeff" },
  ...
  { path:"/maas",id:"maas",title:"Ücret Karar Merkezi",focus:"Ücret, dış benchmark, performans kanıtı ve bütçeyi aşamalı döngüde insan onayıyla yönetin.",steps:["Veri","Yönetici","Bütçe","Onay"],icon:DollarSign,accent:"#0f766e",accent2:"#2563eb",soft:"#f0fdfa" },
  ...
  { path:"/kurulum",id:"kurulum",title:"FutureHR Kurulum",focus:"Yeni şirketi organizasyon, rol/yetkinlik, dönem, ücret ve yetki adımlarıyla pilot kullanıma hazırlayın.",steps:["Şirket","Organizasyon","Dönem","Güven"],icon:Settings2,accent:"#4f46e5",accent2:"#059669",soft:"#eef2ff" },
