...
# --- KADEMELİ EĞİTİM KÜTÜPHANESİ ---
# Seviye 1: Başlangıç (0-3.0 Puan)
# Seviye 2: Orta (3.0-4.0 Puan)
# Seviye 3: İleri (4.0-5.0 Puan)
...
TIERED_EDUCATION_DB = {
    ...
    # Varsayılan (Bilinmeyen kodlar için)
    "DEFAULT": {
        "Level 1": {
...
# --- FONKSİYON ---
def get_tiered_recommendation(comp_code, current_score):
    """Puna göre doğru seviyedeki eğitimi getirir."""
    # Kodu bulamazsa DEFAULT'u getir
    data = TIERED_EDUCATION_DB.get(comp_code, TIERED_EDUCATION_DB['DEFAULT'])
    ...
    result = data[level_key].copy()
    result['level_name'] = level_key
    result['color'] = color
    return result
