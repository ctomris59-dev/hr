...
def dashboard_client():
    ...
    with Session() as db:
        ...
        u1 = UserModel(id="dash-u1", tenant_id=t1.id, employee_id=e1.id, username="ceo1", password_hash=hash_password("password"), role="CEO", active=True, token_version=1)
        u2 = UserModel(id="dash-u2", tenant_id=t2.id, employee_id=foreign.id, username="ceo2", password_hash=hash_password("password"), role="CEO", active=True, token_version=1)
